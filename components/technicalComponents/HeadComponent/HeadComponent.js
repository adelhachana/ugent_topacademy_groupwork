	...
	render() {
		...
		return <>
			<Head>
				...
				{this.state.loaded && <link href="'https://fonts.googleapis.com/css2?family=Special+Elite&family=Wire+One&display=swap'" rel="stylesheet" />}
			</Head>
			<Script id="tawktoscriptwrapper" dangerouslySetInnerHTML={{
				__html: `var Tawk_API=Tawk_API||{ }, Tawk_LoadStart=new Date();
					...
					s1.async=true;
					s1.src='https://embed.tawk.to/636e4797daff0e1306d6eb31/1ghjcfa8p';
					s1.charset='UTF-8';
